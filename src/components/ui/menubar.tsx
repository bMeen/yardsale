...
function MenubarItem({
  ...
  return (
    <DropdownMenuItem
      ...
      className={cn(
        "group/menubar-item focus:bg-primary/10 focus:text-primary not-data-[variant=destructive]:focus:**:text-accent-foreground data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 data-[variant=destructive]:focus:text-destructive dark:data-[variant=destructive]:focus:bg-destructive/20 data-[variant=destructive]:*:[svg]:text-destructive! cursor-pointer gap-1.5 rounded-md p-2 text-sm data-disabled:opacity-50 data-inset:pl-7 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
